...
class ResearchTwoDueDates(tkinter.Frame):
    def __init__(self, parent, controller):
        ...
        tkinter.Label(self, text='Кількості робіт', font=font_bold, bg='white').grid(row=2, column=0, padx=20, pady=10, sticky='ew')
        ...
        tkinter.Label(self, text='Розміри директивних строків', font=font_bold, bg='white').grid(row=3, column=0, padx=20, pady=10,
                                                                                sticky='ew')
